...
export default class SeekBar extends Component {
            ...
            style={[
              this.styles.innerProgressCompleted,
              {
                ...
                backgroundColor:
                  ...
                  this.styles.innerProgressCompleted.backgroundColor,
              },
            ]}
          />
          {/*如果还要加其他进度条，在这儿加*/}
  ...
  componentWillReceiveProps(nextProps, nextContext) {
    if (
      !this.state.isPressed && // 如果自己再拖动过程中，就不要刷新自己，不然会抖动
  ...
  getPositionFromValue(value) {
    ...
    let position =
      this.progressLeft +
      ((this.progressRight - this.progressLeft) * (value - this.props.min)) /
  ...
  updatePosition(position, fromUser = false) {
    ...
    if (position < this.progressLeft) {
      ...
      newValue =
        this.props.min +
        ((this.props.max - this.props.min) * (position - this.progressLeft)) /
